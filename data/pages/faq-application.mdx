...
can also receive the grant as an individual. If your grant is approved, the email notification will contain information on what tax form we need from you in each case.
...
- Ask for funding for a project you have already started working on, with Proof
  of Work.
- Consider starting with an application for a smaller and shorter grant, with clearly defined timelines and milestones. Once you have the chance to build more POW over your first grant period, you can always apply for a 2nd grant with higher budget and longer duration.
- Be humble.
