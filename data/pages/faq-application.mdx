...
summary: 'Answers to frequently asked questions regarding OpenSats applications.'
...
- Provide strong written reference letters from people familiar with your
  work.
...
about your work and that we can reach out to them. Please include the email
address of each reference so we can reach out to verify. Cryptographically
signed references, e.g. using PGP or Nostr, are a plus.
