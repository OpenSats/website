...
All applications which fulfill the criteria will be evaluated by [the
Board][board]. Upon board approval and collection of necessary supplemental
data, approved projects might be showcased on the OpenSats website. If
showcased, donors will be able to contribute funds and recommend that the
OpenSats' board considers their donations be allocated towards these
pre-approved, mission-aligned projects.
