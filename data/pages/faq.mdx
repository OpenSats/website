...
mission are free to [submit an application](/apply) for their
project to be listed on the [OpenSats website](/projects).
...
application](/apply) to be listed on our site.
...
fund](/projects/opensats_operations_budget) which will help
...
[operations budget](/projects/opensats_operations_budget).

  - John Pfeffer, Greg Foss, Ten31, #startsmall, and The Bitcoin Company have contributed to our legal and operational overhead or contributed technical development resources so OpenSats can stay 100% passthrough for all general fund and project specific donations.
