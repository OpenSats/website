...
Budget](/projects/opensats_operations_budget) which will help cover our basic
operational expenses (which we have kept to a minimum) so we can ensure that all
donations intended for Bitcoin and FOSS projects remain 100% passthrough.
