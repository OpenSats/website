---
title: Grantee FAQ
summary: 'Answers to frequently asked questions posed by our grantees.'
...
- [Do you have guidance for border crossings?](#do-you-have-guidance-for-border-crossings)
...
- [Does OpenSats allow funding by multiple organizations at the same time?](#does-opensats-allow-funding-by-multiple-organizations-at-the-same-time)
...
No. All grants are paid in [sats](/topics/sats), i.e. bitcoin. We will request
...
We can't provide legal advice, but several resources offer practical tips for
traveling with devices and data: the [EFF Border Search Pocket Guide][eff] as
well as [these articles][eva] might be helpful. [This article] could be useful
too. Note that various security researchers and developers encourage the use of
[Lockdown Mode][jsr] or a hardened system like [GrapheneOS][final].

[eff]: https://www.eff.org/document/eff-border-search-pocket-guide
[eva]: https://nostr.at/nevent1qqs82d0ywjfc6g8y6hqledpnac5jlnvjmjl4p34hcvg5hwvsz0vj7fqpzdmhxue69uhhwmm59e6hg7r09ehkuef0qgsrhfhexcslfawgj0du2aqhmsngud4kzmga7r4pu8lmmyg3kjy6zhcrqsqqqqqpxdzve9
[this article]: https://www.eff.org/deeplinks/2025/06/journalist-security-checklist-preparing-devices-travel-through-us-border
[jsr]: https://nostr.at/nevent1qqsdzfkq87ux5utdq8zgcnexghnj5h27zn55j7d588vunp3rths09qszypsf7xrv5q3avkxqlcqe2uz89av4vhytu8wpvwc4g8avnkg25n5279vk3h3
[final]: https://nostr.at/nevent1qqsfdvew2fde7lm6tkfqz5m43xxugr998sxe7tfqchfv59uf2yehh3cppamhxue69uhkummnw3ezumt0d5pzps26tfjesmn6ksf5mm36hpf9fkjut49sfeutfutvs2phrykn25v9w093g5
...
commits to GitHub (or equivalent). It is perfectly fine to use GitLab or Gitea or
any other self-hosted repository, as long as it is publicly accessible at all times.
...
All grantees must submit a progress report every 90 days at
https://opensats.org/reports/submit. Make sure to check the report form template before writing your 1st report.

**First-time OpenSats grantees** must also submit 30-day progress reports during the
first three months of their grant period. For example, if a grant starts in
March:

- 30-day reports are due at the end of April, May, and June.
- After that, 90-day reports are due every three months (e.g., September
  covering June–August, December covering September–November, etc.).

**Returning grantees** (second or later grant) submit only 90-day progress
reports. For example, if a grant starts in March:

- Reports are due in June (covering March–May), September (covering
  June–August), December (covering September–November), and every 90 days
  thereafter until the end of the grant.

Occasionally, OpenSats may request additional reports on top of the regular schedule described above.

If a report is not received by the last day of the month due, the grant will be
paused until it is submitted. Progress reports are a required condition of every
OpenSats grant and are necessary for compliance with 501(c)(3) nonprofit
regulations. OpenSats must demonstrate to donors and auditors how grant funds
are used.
...
In addition to reports, OpenSats monitors public repositories to evaluate
grantee performance.
...
Important reminder - OpenSats does not provide indefinite funding for grantees.
Receiving one or more grants in the past does not guarantee the approval of
future applications and we encourage grantees to seek additional funding sources
outside of OpenSats.
...
### Does OpenSats allow funding by multiple organizations at the same time?

Yes, provided you disclose the terms of your other funding (e.g. grants) to OpenSats.
...
[njump]: https://njump.to/npub10pensatlcfwktnvjjw2dtem38n6rvw8g6fv73h84cuacxn4c28eqyfn34f
[c]: /contact
