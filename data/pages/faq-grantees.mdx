...
If your grant started in March, for example, the 1st report will be due anytime during the month of June and should cover the work done from March through May, and so on and so forth. You have a 30-day window to submit the report and we appreciate if you submit them on time.
...
- Has a brief summary in each section before providing additional details (links, PRs, etc).
- Tells us if you are on track, if you had challenges, how you (will) overcome the challenges, if you are pleased or displeased with the progress.
...
- A long wall of text talking about the work but not showing any of the work through relevant links to pull requests and commits.
- Dives directly and only into a long list of links to pull requests and commits without some contextualization of the work done in those links.
