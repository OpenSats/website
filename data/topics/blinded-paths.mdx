---
title: 'Blinded paths'
summary: 'A Lightning feature where the receiver supplies a partial route with hop identities encrypted, so the sender never learns who the destination is.'
category: 'Lightning'
...
- [Bitcoin Optech: Route blinding](https://bitcoinops.org/en/topics/rv-routing/)
