...
BIP 158 is the filter format. [BIP 157](/topics/bip-157) is the peer-to-peer protocol for requesting the filters. Together, they power privacy-preserving SPV in modern Bitcoin wallets like Neutrino, [LDK Node](https://github.com/lightningdevkit/ldk-node), and Nakamoto.
