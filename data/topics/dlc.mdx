---
title: 'DLC'
summary: 'Discreet Log Contracts are Bitcoin contracts whose settlement depends on a signed statement from an oracle, without the oracle seeing the contract or holding any funds.'
ogSummary: 'A Bitcoin contract whose settlement depends on a signed statement from an oracle, without the oracle seeing the contract or holding funds.'
category: 'Bitcoin'
