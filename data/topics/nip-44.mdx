---
title: 'NIP-44'
summary: "Nostr's current encryption standard for direct messages and other private content, designed to hide the message and its length from everyone but the recipient."
ogSummary: "Nostr's current encryption standard for direct messages and other private content, designed to hide the message and its length."
category: 'Nostr'
