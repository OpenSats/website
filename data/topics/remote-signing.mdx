...
This separation lets a user log into a web client without pasting in their nsec, try a new client without re-seeding a keypair, and revoke access for a single client without touching the others. [NIP-46](https://github.com/nostr-protocol/nips/blob/master/46.md) is implemented by Amber, nsecBunker, nsec.app, and most major Nostr clients on desktop and mobile.
