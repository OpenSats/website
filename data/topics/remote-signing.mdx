...
This separation lets a user log into a web client without pasting in their private key, try a new client without re-seeding a keypair, and revoke access for a single client without touching the others. [NIP-46](/topics/remote-signing) is implemented by Amber, nsecBunker, nsec.app, and most major Nostr clients on desktop and mobile.
