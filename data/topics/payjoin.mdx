---
title: 'Payjoin'
summary: 'A cooperative Bitcoin transaction where the receiver also contributes an input, breaking the common-input heuristic, for increased on-chain privacy.'
category: 'Privacy'
