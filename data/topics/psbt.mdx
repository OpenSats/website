---
title: 'PSBT'
summary: 'Partially Signed Bitcoin Transaction: a standard format for transactions that are still being constructed or signed, used by wallets and coordinators.'
ogSummary: 'Partially Signed Bitcoin Transaction: a standard format for transactions that are still being constructed or signed.'
category: 'Bitcoin'
