---
title: 'HTLC'
summary: 'A conditional Bitcoin payment that settles when the receiver reveals a preimage and refunds after a timeout, making it Lightning''s routing primitive.'
category: 'Lightning'
