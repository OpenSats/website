---
title: 'BIP 157'
summary: 'A Bitcoin peer-to-peer extension that lets light clients fetch compact block filters from full nodes, so they can scan the chain without leaking addresses.'
category: 'Bitcoin'
