---
title: 'BIP 157'
summary: 'A Bitcoin peer-to-peer extension that lets light clients fetch compact block filters from full nodes, scanning the chain without leaking addresses.'
category: 'Bitcoin'
