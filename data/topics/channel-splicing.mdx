...
The feature was first deployed in Phoenix and Core Lightning, and has since been standardized in the BOLT specification and implemented across other Lightning nodes. See also the [Splicing project page](/projects/splicing) for OpenSats grants in this area of research.

## References

- [Lisa Neigut's 2018 splicing proposal](https://lists.linuxfoundation.org/pipermail/lightning-dev/2018-October/001463.html)
- [lightning/bolts/PR1160](https://github.com/lightning/bolts/pull/1160)
- [Phoenix splicing update](https://acinq.co/blog/phoenix-splicing-update)
