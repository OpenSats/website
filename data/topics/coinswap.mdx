---
title: 'Coinswap'
summary: 'Atomic multi-hop swaps that move coins through intermediate keys so the spender of an input cannot be linked to the receiver of the final output.'
category: 'Privacy'
