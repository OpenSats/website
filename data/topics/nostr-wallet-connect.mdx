...
[NIP-47](/topics/nostr-wallet-connect) is supported by Alby, Mutiny, LNbits, Phoenix, Zeus, and an increasing number of Lightning wallets. On the client side, Damus, Amethyst, Primal, and most zap-capable Nostr clients speak NWC out of the box.
