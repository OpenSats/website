...
summary: 'A Nostr protocol that lets a client pay and receive Lightning payments through a user-controlled wallet, using relays as the transport.'
category: 'Nostr'
aliases: ['NWC', 'NIP-47']
---
...
[NIP-47](https://github.com/nostr-protocol/nips/blob/master/47.md) is supported by Alby, Mutiny, LNbits, Phoenix, Zeus, and an increasing number of Lightning wallets. On the client side, Damus, Amethyst, Primal, and most zap-capable Nostr clients speak NWC out of the box.
