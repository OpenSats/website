...
Support for [BIP 324](/topics/bip-324) landed in Bitcoin Core 26.0, and has since rolled out to other full-node implementations. Nodes negotiate the new transport on a best-effort basis and fall back to the plaintext protocol when the other side does not support it.
