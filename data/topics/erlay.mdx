---
title: 'Erlay'
summary: 'A bandwidth-efficient Bitcoin relay protocol where peers compare compact transaction summaries instead of flooding every transaction to every peer.'
category: 'Bitcoin'
