...
The protocol is still under active research and development. The site [arkdev.info](https://arkdev.info/) collects current specifications and implementations such as [arkade-os/arkd](https://github.com/arkade-os/arkd).
...
- [arkade-os/arkd](https://github.com/arkade-os/arkd)
