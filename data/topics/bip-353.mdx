---
title: 'BIP 353'
summary: 'Human-readable Bitcoin payment instructions in DNSSEC-signed TXT records, letting a wallet resolve `name@domain` to an address or BOLT 12 offer.'
category: 'Bitcoin'
