...
We don't want any one person or small group to have control of the
decision-making process of OpenSats, so we created a [transparent](/transparency), public-facing, and
...
Past board members include [k3tan](https://k3tan.com/about/),
[Udi](https://x.com/udiWertheimer), [niftynei](/about/niftynei), and
[NVK](/about/nvk).
...
budget which helps OpenSats function, please consider donating to our
...
Our content team writes and maintains the public-facing material on this site.

<Members subset="Content" />

Past contributors include [Ville](/about/ville) and [Julian](/about/julian).
