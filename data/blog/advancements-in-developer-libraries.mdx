...
gaining a simpler interface, implemented [HPKE-encrypted Oblivious HTTP](https://ietf-wg-ohai.github.io/oblivious-http/draft-ietf-ohai-ohttp.html) to help protect data without heavy Tor or TLS dependencies, and recently introduced
a session-event log, creating a standard way for implementors to display transaction
