...
announcements in [July](https://opensats.org/blog/bitcoin-grants-july-2023),
[August](https://opensats.org/blog/bitcoin-and-nostr-grants-august-2023), and
[December](https://opensats.org/blog/bitcoin-grants-december-2023). In case
you’re interested in the types of projects and people we support, we encourage
you to have a look at our [long-term support
grants](https://opensats.org/tags/lts) as well as our [year in
review](https://opensats.org/blog/2023-year-in-review).

As always, let's take a closer look at the projects to understand what they are
about and how they align with [our mission](https://opensats.org/mission).
...
Easy routing allows individuals and companies to experiment and run signet
nodes. An optional public API can allow participants to request interaction with
a 3rd party's signet node such as to ask it to open a channel for you.
...
Firebolt is a wallet that supports both on-chain and lightning transactions. It
runs a custom non-routing Lightning node on the user’s mobile device and
integrates with your nostr contacts. Firebolt is fully non-custodial, supports
CoinJoin and PayJoin transactions, and integrates with peer-to-peer marketplaces
such as Bisq, Peach, and RoboSats.
...
criteria](https://opensats.org/apply#criteria) and we do our best to select only
the [most impactful](https://opensats.org/selection) and promising proposals.
...
<center> <DonateToOperationsButton/> </center>
