...
draft: false
authors: ['BoltC', 'dergigi']
images: ['/static/images/blog/17-bitcoin-dec.jpg']
summary: "OpenSats is funding 9 more open-source projects in the bitcoin space."
---
...
[more](https://opensats.org/blog/recurring-donations-from-bitwise-bitcoin-etf-bitb)
[decades](https://opensats.org/blog/bitcoin-infrastructure-this-decade) to come.

Our board has selected nine more projects for funding. In no particular order,
here they are:
...
Fund](https://opensats.org/projects/general_fund), which is funded by generous
