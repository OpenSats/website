...
As Bitcoin is approaching its next halving event, developers all over the world are working tirelessly to bring about a better future promised by sound and permissionless money. We are trying our best to help bring said future about by providing no-strings-attached funding for the most impactful open-source projects in the Bitcoin ecosystem, and we are planning to do this for many [more](https://opensats.org/blog/recurring-donations-from-bitwise-bitcoin-etf-bitb)  [decades](https://opensats.org/blog/bitcoin-infrastructure-this-decade) to come.

Our board has selected nine more projects for funding. In no particular order, here they are:

- [Splicing in LDK](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.z03co8f3uhtv)
- [Bitcoin Core Testing Suite](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.pphmn292m5so)
- [BLAST](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.ykpsb86jc0xq)
- [Scaling Lightning](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.pignzmkaz8me)
- [Satsigner](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.um15tnd4flme)
- [Firebolt](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.j1wz8utv1yqu)
- [The Bitaxe](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.c5j8eptrjjtf)
- [The Bitcoin LARP Game](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.rqhd6awjurgz)
- [Braidpool](https://docs.google.com/document/d/1uNqoDnbf5bJtcB1cqP9xSGgLUtX1QoZn68oW8tzqzuA/edit#heading=h.kssabwpcuiie)

All of the above grants are sourced from our [General Fund](https://opensats.org/projects/general_fund), which is funded by generous donors like you. If you want to help us support free and open-source projects please consider donating to the fund:

BIG ORANGE BUTTON

—

This marks the fourth wave of grants given to bitcoin projects, following our announcements in [July](https://opensats.org/blog/bitcoin-grants-july-2023), [August](https://opensats.org/blog/bitcoin-and-nostr-grants-august-2023), and [December](https://opensats.org/blog/bitcoin-grants-december-2023). In case you’re interested in the types of projects and people we support, we encourage you to have a look at our [long-term support grants](https://opensats.org/tags/lts) as well as our [year in review](https://opensats.org/blog/2023-year-in-review).

As always, let's take a closer look at the projects to understand what they are about and how they align with [our mission](https://opensats.org/mission).
...
Repository: [niftynei/BASIC](https://github.com/niftynei/BASIC)
...
Easy routing allows individuals and companies to experiment and run signet nodes. An optional public API can allow participants to request interaction with a 3rd party's signet node such as to ask it to open a channel for you.

Repository: [scaling-lightning/scaling-lightning](https://github.com/scaling-lightning/scaling-lightning)
...
Firebolt is a wallet that supports both on-chain and lightning transactions. It runs a custom non-routing Lightning node on the user’s mobile device and integrates with your nostr contacts. Firebolt is fully non-custodial, supports CoinJoin and PayJoin transactions, and integrates with peer-to-peer marketplaces such as Bisq, Peach, and RoboSats.

The wallet is still in beta and under heavy development. Use with caution.

Repository: [AreaLayer/FireBolt](https://github.com/AreaLayer/FireBolt)
...
We are evaluating applications based on carefully [defined criteria](https://opensats.org/apply#criteria) and we do our best to select only the [most impactful](https://opensats.org/selection) and promising proposals.

Thank you for your continual and generous support. As we don't take a cut from donations to open-source projects, we couldn't be doing what we are doing without your help. If you want to help us cover our operational expenses, please consider donating to our [operations budget](https://opensats.org/projects/opensats_operations_budget).
