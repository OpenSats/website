...
This round of funding features five first-time grants for projects focused on
advancing the protocol across key areas like identity, coordination, and
usability:
...
connectionscritical for maintaining uninterrupted signing sessions,
...
Including this wave of funding, OpenSats is proud to have allocated over $XY
from [The Nostr Fund](/funds/nostr)—marking a mid-year milestone in our
mission to support critical tools, infrastructure, and developers across the
nostr ecosystem.
