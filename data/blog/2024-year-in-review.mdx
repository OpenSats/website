...
year. That said, we are incredibly pleased to see that our structure and
...
major track record of doing important work related to bitcoin infrastructure.
...
With all that said, nostr is still an incredibly young network, which is why we will continue to fund experimental
...
roster in 2024. As mentioned before, we also gave grants
to developers who [test and review](/blog/caring-for-bitcoin-core) Bitcoin Core.
