...
share an update in regards to the donations we received, and give an overview of
...
But before we dive into the various graphs and numbers, let us spend a minute to
remind everyone—and most importantly ourselves—_why_ we are doing what we are
doing.  _"I'm convinced that to give away a dollar effectively is harder than to
make a dollar,"_ Steve Jobs once mentioned in an interview. And indeed, making
sure that grants are given to the right projects at the right time—in other
words: making sure that [grant selection](/selection) is done fairly and
properly—is an incredibly hard problem.
...
projects, especially those who make bitcoin flourish. While we are just a small
part of a larger ecosystem, a public charity is the right tool for us, as it is
independent of quarterly profits and not funded by the state. And while we
experimented with direct crowd funding in the beginning, we quickly learned that
most people want to outsource the selection process, which is understandable.

Part of the [mission of OpenSats](/mission) is to help solve what is known as
the "tragedy of the commons" which, as the name implies, is a _tragedy_, and
thus not a problem that can be solved perfectly. It is probably as old as
society itself, and we will probably try to "solve" it for as long as societies
continue to exist. Like any parennial problem, there's no final solution, only
trade-offs. Not every rustling bush has a tiger in it, but if you don't run away
often enough you will get mauled by one eventually. In our case the trade-off is
not tigers, but funding projects that shouldn't be funded vs the risk of _not_
funding projects that should be.



- Less prone to popularity contests
- More efficient (and less corrupt) than a state
- independent from quarterly profits of a company.

We don't claim to have all the answers, but we believe that an entity like OpenSats _needs_ to exist, which is why we set out to create it.

there's three things that we want to bring to the table:
...
a longer time horizon than regular grants, the LTS program is geared towards long-term stability for grantees
...
>
><cite>—[opensats.org/about](/about)</cite>
...
major track record, both doing important work related to bitcoin infrastructure.
...
Speaking of long-term support, in March we announced the expansion of our LTS
program to provide [long-term support for nostr
developers](/blog/nostr-lts-long-term-support-for-nostr-developers) also, which
...
privately, securely, and in a way that empowers them, as opposed to the
...
this will remain to be the case for decades to come. By [renewing our commitment
...
projects that help bitcoin flourish, especially those that suffer from the
tragedy of the commons, such as Bitcoin itself. We will continue to [support
core developers](/tags/core), whether it’s seasoned veterans or [up-and-coming
devs](/blog/caring-for-bitcoin-core), as announced in August. If you are a
developer who wants to quit their soul-sucking fiat job to work on freedom tech,
don’t hesitate to [apply for funding](/apply).
...
who donated to [our funds](/funds) as well as our [operations
...
announced by Cathy Wood, who [pledged to donate a fixed percentage of Ark’s
...
We hope to receive multiple commitments of this sort from various entities, as
...
As mentioned in last year’s report, we suspect that the distinction between
“bitcoin” and “nostr” will get more blurry over time, as nostr matures and gets
integrated into a variety of bitcoin software across the stack. This is already
happening, especially on the eCash front. Are [Cashu
...
clients, or bitcoin wallets? And what about P2P exchanges that use nostr to
publish their order books? It is obvious to us that various concepts and
technologies are currently merging, and we expect this cross-pollination of
ideas to continue.

With all that said, nostr is still an incredibly young network. It is just
coming out of its infancy, which is why we will continue to fund experimental
...
terms of gross amounts the top five categories that we gave grants to are
Bitcoin Core, Lightning, eCash, Education, and Privacy.
...
[Jon](/blog/jon-atack-receives-lts-grant). The last three were added to our LTS
roster in 2024. In addition to these long-term grants we gave smaller grants to
[three up-and-coming core developers](/blog/caring-for-bitcoin-core).
...
[Vexl](https://github.com/vexl-it/vexl), [LNbits](https://github.com/lnbits),
[El Tor](https://bitbucket.org/eltordev/eltor), [BTCPay
Server](https://github.com/btcpayserver), and
...
fantastic to see that custom feeds via DVMs—something that was pure
...
this year: [Zapstore](https://github.com/zapstore/zapstore),
...
[Nostrmo](https://github.com/haorendashu/nostrmo), [Captain's
Log](https://github.com/nodetec/comet),
[Osty](https://github.com/ostyjs/create-osty/),
[Voyage](https://github.com/dluvian/voyage),
[alphaama](https://github.com/eskema/alphaama), [dart_ndk +
yana](https://github.com/relaystr/ndk),
...
[Whitenoise](https://github.com/erskingardner/whitenoise),
...
[DVMDash](https://github.com/dtdannen/dvmdash), and
...
Bitcoin is getting more secure, more private, and easier to use by the minute.
...
One that is resistant to censorship and downtime alike; one that has
...
But much is still left to be done. Bitcoin, Lightning, and nostr are far from
perfect, and as these and other protocols are evolving, we will do our best to
...
and open-source projects and contributors, especially bitcoin-related projects
and projects that help bitcoin flourish. We hope that our track record will
...
ecosystems grow and specialize. We don’t have a crystal ball of course, but from
...
hardware will gain in importance as well. Bitcoin will remain to be of the
utmost importance of course, and as it enters the political arena of the world
stage we expect to see multiple non-profits being created to support open-source
...
Last but not least, we want to dedicate this last paragraph to all of you.
Whether you are a donor, a grantee, a future applicant, or simply an interested
reader who is interested in bitcoin and freedom tech—the revolution that is
currently happening is only happening because of all of you. We are incredibly
thankful for your time, care, and attention. You could be spending it on
anything else, but you choose to spend it on bitcoin and freedom tech. Thank
you. We are beyond grateful for the support we received, both monetarily as
well as in the form of community and [volunteer efforts](/about#volunteers), and
it's exhillerating to see the technical progress across [projects we
support](/projects/showcase).  You are what makes all of this work, and we
