...
project and runs a community instance at [relay.pleb.one] with invite-only
Web-of-Trust access and an admin dashboard for managing invites.
Comparable self-hostable implementations include [pyramid] by fiatjaf and [WoT
Relay] by utxo.
