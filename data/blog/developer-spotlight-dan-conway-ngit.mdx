...
<details id="ngit-to-github-mirror-walkthrough" className="my-8 rounded-lg border border-gray-200 p-4 dark:border-gray-700 sm:p-6">
<summary className="cursor-pointer text-xl font-bold text-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 dark:text-gray-100">
