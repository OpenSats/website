...
draft: false
authors: ['dergigi']
summary: "OpenSats is funding 15+ open-source projects in the nostr ecosystem"
---

The [mission] of OpenSats is to support and maintain a sustainable ecosystem of
funding for free and open-source projects which help Bitcoin flourish. Nostr is
such a project, which is why OpenSats introduced The Nostr Fund
and [built a team around the protocols originator][startsmall] to help support the builders
that are trying to do open, interoperable, and censorship-resistant social media
right.
...
In no particular order, here they are:
  ...
  - NDK by [@pablof7z](https://nostr.com/npub1l2vyh47mk2p0qlsku7hg0vn29faehy9hy34ygaclpn66ukqp3afqutajft)
  - Habla by [@verbiricha](https://nostr.com/npub107jk7htfv243u0x5ynn43scq9wrxtaasmrwwa8lfu2ydwag6cx2quqncxg)
  - Coracle by [@hodlbod](https://nostr.com/npub1jlrs53pkdfjnts29kveljul2sm0actt6n8dxrrzqcersttvcuv3qdjynqn)
  - Iris by [@mmalmi](https://nostr.com/npub1g53mukxnjkcmr94fhryzkqutdz2ukq4ks0gvy5af25rgmwsl4ngq43drvk)
  - Damus by [@jb55](https://nostr.com/npub1xtscya34g58tk0z605fvr788k263gsu6cy9x0mhnm87echrgufzsevkk5s)
  - rust-nostr & nostr-sdk by [@yukibtc](http://npub1drvpzev3syqt0kjrls50050uzf25gehpz9vgdw08hvex7e0vgfeq0eseet)
  - Nostr Relay NestJS by [@CodyTseng](https://nostr.com/npub1syjmjy0dp62dhccq3g97fr87tngvpvzey08llyt6ul58m2zqpzps9wf6wl)
  - Soapbox by [@alexgleason](https://nostr.com/npub108pv4cg5ag52nq082kd5leu9ffrn2gdg6g4xdwatn73y36uzplmq9uyev6)
  - Nozzle by [@dluvian](https://github.com/dluvian)
  - Code Collaboration over Nostr by [@DanConwayDev](https://nostr.com/npub15qydau2hjma6ngxkl2cyar74wzyjshvl65za5k5rl69264ar2exs5cyejr)
  - Satellite by [@lovvtide](https://nostr.com/npub1lunaq893u4hmtpvqxpk8hfmtkqmm7ggutdtnc4hyuux2skr4ttcqr827lj)
  - Amethyst by [@vitorpamplona](https://nostr.com/npub1gcxzte5zlkncx26j68ez60fzkvtkm9e0vrwdcvsjakxf9mu9qewqlfnj5z)
  - Pinstr by [@sepehr-safari](https://nostr.com/npub18c556t7n8xa3df2q82rwxejfglw5przds7sqvefylzjh8tjne28qld0we7)
  - nostr.build by [@nostr.build](https://nostr.com/npub1nxy4qpqnld6kmpphjykvx2lqwvxmuxluddwjamm4nc29ds3elyzsm5avr7)
  - Gossip by [@mikedilger](https://nostr.com/npub1acg6thl5psv62405rljzkj8spesceyfz2c32udakc2ak0dmvfeyse9p35c)
  - Nostr Design by [@karnage](http://nostr.com/npub1r0rs5q2gk0e3dk3nlc7gnu378ec6cnlenqp8a3cjhyzu6f8k5sgs4sq9ac)

  
Let's take a closer look at each of these projects after the fold.
...
between, better, more reliable, and overall nicer to work with than existing
solutions. The core goal of NDK is to improve the decentralization of Nostr via
intelligent conventions and data discovery features without depending on any one
central point of coordination, such as large relays or centralized search
providers.
...
[Habla](https://habla.news/) is a website for reading, writing, curating, and
monetizing long-form content on nostr. It uses NIP-23 to allow markdown
formatting on articles, which can embed any nostr content such as notes,
profiles, lists, relays, badges, and more. The goal of Habla is to give everyone
an alternative to centralized publishing platforms such as Medium or Substack,
...
feeds, as well as an offline mode, and speedy account creation.
...
### Nostr Relay NestJS: [https://github.com/CodyTseng/nostr-relay-nestjs](https://github.com/CodyTseng/nostr-relay-nestjs)
...
### Soapbox: [https://gitlab.com/soapbox-pub](https://gitlab.com/soapbox-pub)

[Soapbox](https://soapbox.pub/) is an open-source software suite that makes decentralized social media accessible to everyone through a focus on design, user experience, and the growth of the network. Soapbox started out as an alternative to Mastodon but has grown to encompass ActivityPub and nostr while being interoperable with both. In February 2023, the team launched the "Mostr" bridge, seamlessly connecting Nostr to the ActivityPub Fediverse and enabling bidirectional communication between both protocols. This bridge exposes over 9.4M potential users in Nostr's target audience to Nostr, many of whom have already left the Fediverse completely in favor of Nostr.

Repository: 
License: GNU Affero General Public License v3.0

### Nozzle: [https://github.com/dluvian/Nozzle](https://github.com/dluvian/Nozzle)

Nozzle is a lean and lightweight Nostr client for Android. The goal is to have a
great mobile client on low-performance devices. Further, Nozzle aims to make
Nostr more decentralized by organically discovering relays and requesting
content only from those relays which really have the posts a user is looking
for. This reduces the load on relay operators, lowers users' mobile data usage,
and promotes the utilization of smaller relays instead of only interacting with
a few big (and centralizing) ones.

Repository: 
License: MIT

### Code Collaboration over Nostr: [https://github.com/DanConwayDev/ngit-cli](https://github.com/DanConwayDev/ngit-cli)
...
### Satellite: [https://github.com/lovvtide/satellite-web](https://github.com/lovvtide/satellite-web)
...
### Amethyst: [https://github.com/vitorpamplona/amethyst/](https://github.com/vitorpamplona/amethyst/)
...
### Pinstr: [https://github.com/sepehr-safari/pinstr](https://github.com/sepehr-safari/pinstr)

[Pinstr](https://pinstr.app/) allows users to easily organize and discover new
ideas by creating public boards full of pins. Users can star, comment, and zap
other users' boards. Users can find curated boards of other users or create
boards themselves. Default boards include other users' bookmarked content, among
other things.

Repository: 
License: MIT

### nostr.build: [https://github.com/nostrbuild/nostr.build](https://github.com/nostrbuild/nostr.build)

[Nostr.build](https://nostr.build/) is a free-to-use media hosting service that
allows users to upload images, gifs, videos, and audio to share them as nostr
events. The team recently released their code under an MIT License so that
anyone might use the software to offer a similar service.

Repository: 
License: MIT

### Gossip: [https://github.com/mikedilger/gossip](https://github.com/mikedilger/gossip)
...
Nostr Design is a comprehensive resource for designers and developers to build
successful nostr products. Nostr introduces several new concepts that most
...
To all the projects that applied and didn't get funded this time around: please
don't be discouraged and feel free to apply again in the future. We will
announce new grants and funding opportunities quarterly, and there is always the
possibility of being listed on the OpenSats website to receive pass-through
donations for your project.

If you are working on an open-source project related to bitcoin or nostr,
[please apply](https://os-website-adp4mr4iw-open-sats.vercel.app/apply).

[apply]: /apply
[nostr-fund]: /projects/nostr
[mission]: /mission
[startsmall]: /blog/%20opensats-receives-additional-funding-of-dollar10m-from-startsmall