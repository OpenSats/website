...
the challenge with this version was that it required real-time coordination,
...
major improvement called asynchronous transactions. Due to this, Payjoin V2 no
...
easier for mobile wallets and exchanges to integrate Payjoin without disrupting
their existing user workflows, making privacy and security protections more
accessible to a wider audience.

In December 2024, Bull Bitcoin became the first bitcoin exchange to process
Payjoin V2 withdrawals natively. This
[milestone](https://www.bullbitcoin.com/blog/bull-bitcoin-wallet-payjoin) marks
a significant shift. Not only does Payjoin enhance privacy and security, but it
...
grantee [Josi Baker](/blog/josi-baker-receives-opensats-lts-grant), Silent
Payments ([BIP
...
transaction handling, alongside ongoing work on the [libsecp256k1] module to
...
The advancements achieved by OpenSats grantees in Payjoin, Coinswap, and Silent
Payments mark significant progress with on-chain privacy, disrupting transaction
...
[libsecp256k1]: https://github.com/bitcoin-core/secp256k1?tab=readme-ov-file#libsecp256k1
[Rust-Bitcoin]: https://github.com/rust-bitcoin/rust-bitcoin?tab=readme-ov-file#rust-bitcoin
