...
anymore, making it a useless heuristic for transaction deanonymization. _"The
main problem is that,"_ as Francis Pouliot, CEO of [Bull
Bitcoin](https://www.bullbitcoin.com/) pointed out, _"to make it happen, a lot of
open-source software infrastructure was missing."_

Version 1 of Payjoin ([Pay-to-EndPoint](/topics/payjoin))
