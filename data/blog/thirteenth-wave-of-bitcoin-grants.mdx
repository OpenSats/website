...
- [Caring for Core](/blog/caring-for-bitcoin-core#hodlinator)

Each project addresses a specific need—from drop-in Tor libraries and Silent
Payments coordination to sat-sized, account-free Lightning paywalls, hardened
live-OS builds, and merchant-ready e-cash wallets—strengthening privacy and
...
[Samourai](https://github.com/Samourai-Wallet),
...
brings Lightning-powered paywalls straight into the web-server layer. Written in
...
Repository:
[macgyver13/silent-payment-hub](https://github.com/macgyver13/silent-payment-hub)  
License: MIT
...
Every grant application has passes a [mission-aligned](/mission) review process.
