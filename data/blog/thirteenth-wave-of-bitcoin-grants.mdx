...
a simple interface with new Swift- and Kotlin-based bindings to the Cashu Dev Kit
([CDK](https://github.com/cashubtc/cdk)). Powered by
...
[Taproot](/topics/taproot) outputs without any
