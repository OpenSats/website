...
draft: false
authors: ['arvin', 'dergigi', 'btcschellingpt', 'julian']
...
General Fund highlighting our commitment to support individual contributors
...
down on our support for 9 exceptional projects advancing the Bitcoin ecosystem.
...
for a grant](https://opensats.org/apply/grant).
