...
<div className="not-prose">
  <a href="https://opensats.org/apply" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-6 rounded-md no-underline leading-tight">
    Apply for a Grant
  </a>
</div>
