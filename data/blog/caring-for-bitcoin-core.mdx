...
[@davidgumberg (David Gumberg)](#@davidgumberg)

[@hodlinator](#@hodlinator)

In addition to the above, we are supporting the development of the [Bitcoin Core
App](#Bitcoin-Core-App), a modernized user interface for Bitcoin Core.
...
](https://github.com/bitcoin/bitcoin)PRs:
[created](https://bitcoinacks.com/?flt1_author_contains=tdb3),
[reviewed](https://bitcoinacks.com/?flt1_reviewer_contains=tdb3)
...
[created](https://bitcoinacks.com/?flt1_author_contains=davidgumberg),
[reviewed](https://bitcoinacks.com/?flt1_reviewer_contains=davidgumberg)
...
contributors, diagnosing and addressing the slowness of the
`[feature_dbcrash.py](https://github.com/bitcoin/bitcoin/pull/29791)` test,
...
](https://github.com/bitcoin-core)PRs:
[created](https://bitcoinacks.com/?flt1_author_contains=hodlinator),
[reviewed](https://bitcoinacks.com/?flt1_reviewer_contains=hodlinator)
...
Repository:
[bitcoin-core/gui-qml](https://github.com/bitcoin-core/gui-qml?tab=MIT-1-ov-file)
...
Dimov](/blog/vasil-dimov-receives-lts-grant), [Gleb
Naumenko](/blog/gleb-naumenko-receives-lts-grant), [Will
Clark](/blog/will-clark-receives-lts-grant-for-bitcoin-core),
[0xB10C](/blog/furszy-receives-lts-grant-for-bitcoin-core), and [Bruno
...
decentralization of the Bitcoin network. Together, we can build a stronger
