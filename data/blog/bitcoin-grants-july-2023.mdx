...
lightning ecosystem. The following projects were selected by the OpenSats board
according to our [grant selection
...
While many bitcoiners will probably know most of these projects, let's take a
closer look at each of them in turn:
...
In addition to the open-source projects above, we funded three educational
efforts: [Bitcoin Education in
Nigeria](https://geyser.fund/project/bitcoineducationinnigeriawithapatajohnson),
21 Ideas, and one of the upcoming CoreDev Events. The first is an initiative
started and led by Apata Johnson. Apata's project aims to educate youths on
bitcoin and the opportunities it brings for the people living in the rural areas
of Nigeria. The second, [21 Ideas](https://www.21ideas.org/), is a project that
aims to bring quality Bitcoin education to Russian citizens. Tony and others
have been working for many years on translations, original material, and
hands-on tutorials for beginners. We believe that education is paramount to
proper Bitcoin use, and localization is paramount for everyday citizens to
properly grasp the importance as well as the novel concepts of bitcoin. Last but
not least, we provide financial support for one of the upcoming
[CoreDev](https://coredev.tech/) developer events, which is all about bringing
developers together so that they can hack on Bitcoin Core and related projects.
