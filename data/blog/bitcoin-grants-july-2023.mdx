...
The goal of OpenSats is to help build the tools that
...
put it.[^fn-assange] We believe that freedom tech is what carries this smile forward,
which is why we are delighted to announce grants for over a dozen projects in the bitcoin &
lightning ecosystem.
...
The following open-source projects were [selected](https://github.com/OpenSats/website/blob/master/docs/grant-selection.md) to by the
OpenSats board for funding:
...
In addition to the open-source projects listed above, three
educational initiatives were selected:

- [Bitcoin Education in Nigeria](https://geyser.fund/project/bitcoineducationinnigeriawithapatajohnson)
- [21 Ideas](https://www.21ideas.org/)
...
The second, 21 Ideas, is a project that aims to
...
CoreDev developer events, which is all about bringing
developers together so that they can hack on Bitcoin Core and related software.

With that out of the way, let's take a closer look at the free and open-source
software projects of this funding round.
