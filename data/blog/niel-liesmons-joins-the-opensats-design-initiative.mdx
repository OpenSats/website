---
title: "Niel Liesmons Joins the OpenSats Design Initiative"
date: '2023-10-19'
...
help "take nostr mainstream," to quote our furry friend with purple-colored
...
announce a new addition to the OpenSats design team: Niel Liesmons.

[INSERT DESIGN TEAM CIRCLE VIEW]
...
Some nostr OGs will look at these screenshots with a smile that only nostalgia
can produce. All great things have humble beginnings, and nostr is no exception.
Most great things adapt, evolve, and improve over time. And nostr is no
exception in that regard either.
...
https://www.youtube.com/watch?v=7zuCwmS--dY
...
And if it was useful to you, please let us know too! Here's some success stories
of Nostr Design so far: Lume improved their onboarding based on our feedback
0xchat made various UI improvements noStrudel is implementing recommendations
Spring in its current shape is based on NostrDesign recommendations
