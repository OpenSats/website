...
budget, with \$15,000,000 going to our General Fund, \$5,000,000 to The Nostr
Fund, and \$1M to our operations budget.
...
[freedom tech
infrastructure](https://opensats.org/blog/bitcoin-infrastructure-this-decade),
...
[Reynolds
Foundation](https://opensats.org/blog/opensats-receives-one-million-from-reynolds-foundation).
...
If you are aligned with [our mission](https://opensats.org/mission) and are in
...
one of [our funds](https://opensats.org/funds). Every sat counts, and every
little bit helps.
...
If you are an open-source developer in need of funding, don't hesitate to apply: [opensats.org/apply](https://opensats.org/apply)
