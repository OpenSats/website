...
OpenSats has funded LDK work through the [February 2024 grant that included splicing in LDK](/blog/bitcoin-grants-feb-2024#splicing-in-ldk) and through [Shashwat Vangani's LTS grant](/blog/shashwat-vangani-receives-lts-grant), which supports BOLT 12 deployment in LDK. The [Advancements in Developer Libraries](/blog/advancements-in-developer-libraries#splicing-in-ldk) impact report covers how that splicing work progressed. Together, this support helped move BOLT 12 features such as blinded paths, invoice overpayments, and invoice-request retries forward, while also pushing the library toward interoperable channel splicing.
