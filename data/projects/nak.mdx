...
nym: 'fiatjaf'
coverImage: '/static/images/projects/nak.jpg'
...
with commands and code paths for bunker signing, negentropy sync,
git-related workflows, Blossom, wallet operations, `nsite`, `nostrfs`, and
...
Development is active. `nak` shipped [v0.19.12][releases] on June 9, 2026, and
