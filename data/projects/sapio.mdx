...
For example, with Sapio you can generate an address that represents a Lightning channel between you and a friend, then give that address to a third-party service like an exchange to have them create the channel without requiring any signature interaction from you or your friend, using zero trusted parties, and an inability to differentiate your address from any other. That’s the tip of the iceberg of what Sapio lets you accomplish.
