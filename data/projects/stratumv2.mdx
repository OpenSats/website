...
OpenSats has funded Stratum V2 development since August 2023, starting with a grant to [Gabriele Vernetti][gitgab19] for a [testing and benchmarking tool][wave-aug23]. Gabriele went on to lead the [Stratum V2 Reference Implementation][SRI] (SRI) through releases [`1.0.0`][sri-1-0] to [`1.6.0`][sri-1-6], build the [sv2-wizard] configuration tool, and coordinate interoperability testing with pools and hardware vendors. In early 2026, [Lucas Balieiro][lucas] received a grant focused on [fuzzing, security testing, and developer tooling][wave-16].
...
[sri-1-0]: https://github.com/stratum-mining/stratum/releases/tag/v1.0.0
[sri-1-6]: https://github.com/stratum-mining/stratum/releases/tag/v1.6.0
