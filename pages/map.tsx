      ...
      <div>
        <div className="pb-6 pt-6">
          <p className="text-2xl leading-9 text-gray-500 dark:text-gray-400 sm:text-3xl md:text-4xl md:leading-relaxed">
            OpenSats has allocated <Link href="/transparency" className="border-b border-primary-500/40 hover:border-primary-500">${usdAllocated} USD</Link> to free and open-source projects and sent <Link href="/transparency" className="whitespace-nowrap border-b border-primary-500/40 hover:border-primary-500">~{satsSent} sats</Link> to <Link href="/transparency" className="border-b border-primary-500/40 hover:border-primary-500">{grantsGiven} grantees</Link> in <strong className="whitespace-nowrap">40+ countries</strong>.
          </p>
        </div>
