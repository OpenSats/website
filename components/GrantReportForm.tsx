    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
          ...
          <div className="flex">
            ...
            <div className="ml-3 flex-1">
              ...
              <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                <p>
                  We've recovered your previously entered data. You can continue
                  editing or submit it.
                </p>
              </div>
              <div className="mt-2">
                <button
      ...
      {!showPreview ? (
        <div className="flex justify-end">
          <FormButton type="button" variant="enabled" onClick={() => setShowPreview(true)}>
            Preview Report
          </FormButton>
        </div>
      ) : (
        <>
          <div className="mt-8 border-t border-gray-200 pt-6">
            ...
            <div className="mt-6 flex justify-between">
              ...
              <FormButton type="submit" variant={loading ? 'disabled' : 'enabled'} loading={loading}>
                Submit Report
              </FormButton>
            </div>
          </div>
