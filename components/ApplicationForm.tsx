...
export default function ApplicationForm() {
  ...
  return (
    <form
      ...
      className="apply flex max-w-2xl flex-col gap-4 p-4"
    >
      ...
      <label>
        ...
        <input type="text" {...register('project_name', { required: true })} />
      </label>
      ...
      <label>
        ...
        <small>
          ...
          a grant from the general fund, please submit a proposed budget around
      ...
      <label>
        Your Name *<small>Feel free to use your nym.</small>
        <input type="text" {...register('your_name', { required: true })} />
      </label>
      <label>
        Email *
