    ...
    >
      ...
      <label className="block">
        ...
        <small>
          ...
          from the very first draft all the way to the final code or educational material delivered,
          everything produced under an OpenSats grant must be available to the public at all times.
