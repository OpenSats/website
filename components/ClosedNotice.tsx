      ...
      <div className="flex">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            what kind of projects we support and get familiar with our{' '}
            <Link href="/selection">grant selection process</Link> if you want
            to prepare a submission. We will re-open applications again soon.
            (Two weeks&trade;)
          </p>
        </div>
      </div>
