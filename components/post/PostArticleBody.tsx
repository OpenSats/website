...
const postArticleBodyClasses = {
  default: {
    ...
    tagsBlock: 'py-4 xl:py-8',
    paginationBlock: 'flex justify-between py-4 xl:block xl:space-y-8 xl:py-8',
    backLinkBlock: 'pt-4 xl:pt-8',
  },
  spotlight: {
    wrapper:
    ...
    backLinkBlock: 'pt-4 min-[1000px]:pt-8',
  },
} as const
