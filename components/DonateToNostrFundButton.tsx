  ...
  return (
    <>
      <button
        ...
        className="mx-auto mb-4 mt-8 block rounded bg-purple-500 px-4 py-2 font-semibold text-white hover:border-transparent hover:bg-purple-500 hover:text-black dark:text-black dark:hover:text-white"
      >
