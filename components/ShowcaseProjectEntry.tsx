...
const ShowcaseProjectEntry: React.FC<ShowcaseProjectEntryProps> = ({
  ...
  return (
    <li
      className={
        isSlide
          ? 'w-full min-w-full shrink-0 snap-start px-1 py-2'
    ...
    >
      <article
        className={
          isSlide
            ? 'grid grid-cols-[4rem_minmax(0,1fr)] items-start gap-3 sm:grid-cols-[6rem_minmax(0,1fr)] sm:gap-5'
            : 'relative grid grid-cols-[4rem_minmax(0,1fr)] items-start gap-3 pr-6 sm:grid-cols-[6rem_minmax(0,1fr)] sm:gap-5 sm:pr-0'
        }
      >
        ...
        <div className="min-w-0">
          ...
          <p
            className={
              isSlide
                ? 'pt-3 text-sm font-medium leading-6'
                : 'hidden pt-3 text-right text-sm font-medium leading-6 sm:block'
            }
          >
            <Link
              href={slug}
