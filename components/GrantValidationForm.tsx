...
export default function GrantValidationForm({ onValidationSuccess }: GrantValidationFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
      ...
      <div>
        ...
        />
        {errors.grant_id && (
          <span className="text-sm text-red-600">{errors.grant_id.message}</span>
        )}
      </div>
